 ...
 <div class="d-flex justify-content-center mb-4 mt-4">
 	<h5 class="font-weight-bold">Tambah Data Objek Wisata</h5>
 </div>
 <form method="POST" action="<?= site_url('wisataa/save_aksi') ?>" enctype="multipart/form-data">
 	<div class="row">
 		<div class="col-md-6">
 			<div class="form-group">
 				<label for="nama_wisata" class="control-label">Nama Wisata</label>
 				<input type="text" id="nama_wisata" name="nama_wisata" class="form-control" required>
 			</div>
 			<div class="form-group">
 				<label for="alamat_wisata" class="control-label">Alamat Wisata</label>
 				<input type="text" id="alamat_wisata" name="alamat_wisata" class="form-control" required>
 			</div>
 			<div class="form-group">
 			...
 			<div class="form-group">
 				...
 				<input type="file" id="foto_wisata" name="foto" class="form-control" required>
 			</div>
 			<div class="form-group">
